          ...
          <div>
            {data.map((datas) => (
              <Card>
                ...
                <H2>
                  {" "}
                  Project {datas.projectname} is Complted by {datas.creatorName}
                  <span>
                    {datas.creatorId === "0" ? <Numb></Numb> : <div></div>}
                  </span>
                  {datas.demo && (
                    <span>{datas.demo ? <Numb2></Numb2> : <div></div>}</span>
                  )}
                </H2>
                <NavLink
                  to={`/business/${id}/projectarrivingdetails/${datas.id}/completeddetails/`}
                >
                  Review
                </NavLink>
              </Card>
